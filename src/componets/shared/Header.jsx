    ...
    <nav className="mx-auto md:px-60 flex justify-between py-3 navbar bg-secondary text-black z-30 sticky top-0 left-0 right-0">
      ...
      <div className="dropdown dropdown-end">
        ...
        <ul tabIndex={0} className="menu menu-compact text-black bg-white dropdown-content mt-3 p-2 shadow rounded-box w-52">
          ...
          <li><NavLink to="/all-toys" activeClassName="active">All Toys</NavLink></li>
          {user && (
            <>
              <li><NavLink to="/my-toys" activeClassName="active">My Toys</NavLink></li>
              <li><NavLink to="/add-toys" activeClassName="active">Add Toys</NavLink></li>
      ...
      <ul className="hidden lg:flex gap-10 items-center">
        ...
        {user && (
          <>
            ...
            <li><NavLink to="/add-toys" activeClassName="active">Add Toys</NavLink></li>
            <li>
              <div className="w-10 h-10 rounded-full overflow-hidden" title={user.displayName}>
                <Link to="/profile">
                  <img
                    className="hover:cursor-pointer"
                    src={user.photoURL || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460__340.png"}
